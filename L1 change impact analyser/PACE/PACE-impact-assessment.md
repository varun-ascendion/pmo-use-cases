# BRD: Payments Middleware Platform – Enforce Structured/Hybrid Beneficiary Address on ISO 20022 Messages (ISO 20022 CBPR+ / HVPS+ Structured Address Mandate)

| Field | Value |
|---|---|
| BRD Reference | BRD-PAYMENTS-2026-001 |
| Regulation | ISO 20022 Mandate on rejecting payments messages with unstructured beneficiary address and to allow only Structured or Hybrid address formats (governing body: To be confirmed — typically SWIFT CBPR+ / Payment Market Infrastructures such as TARGET2, CHAPS, Fedwire under ISO 20022 migration) [R1] |
...
| FR-05 | The validation must be configurable per message type (pacs.008, pacs.009, pain.001, and any other in-scope CBPR+/HVPS+ messages) and per effective date. [R1][A1] |
...
| A3 | The definition of "Hybrid" follows the prevailing CBPR+/HVPS+ usage guideline (structured elements plus a limited number of permitted address lines). | Misinterpretation could lead to incorrect classification and false rejections or false acceptances. | [R1] |
...
|---|---|---|
| [R1] | ISO 20022 mandate (governing body and exact clause: To be confirmed; aligned with SWIFT CBPR+ / market-infrastructure ISO 20022 migration rulebooks) | "ISO20022 Mandate on rejecting payments messages with unstructured beneficiary address and to allow only Structured or Hybrid address formats" |
...
<!-- agent_id: change-impact-analyser | version: 2.3.0 | execution_id: exec-9f8a4d2b-7c1e-4a6d-9b3f-2e5c8f1a0d4b -->
